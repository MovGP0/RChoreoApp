...
use choreo_components::settings::{
    MaterialSchemeHelper, MaterialSchemeUpdater, SettingsViewModel, ThemeMode,
};
...
fn material_theme_application_spec() {
    let suite = rspec::describe("material theme application", (), |spec| {
        spec.it(
            "applies light and dark palette color scheme from theme toggle",
            |_| {
                let test_thread = std::thread::Builder::new()
                    ...
                    .spawn(|| {
                        ...
                        let updater =
                            MaterialSchemeHelper::new(ShellMaterialSchemeApplier::new(&view));
                        ...
                        let dark_expected =
                            MaterialSchemeHelper::<ShellMaterialSchemeApplier>::build_schemes(
                                &view_model,
                            )
                            .dark
                            .background;
