...
fn scale_positions_scales_selected_positions_from_center() {
    ...
    check!(errors, (state.positions[0].x + 2.0).abs() < 0.0001);
    check!(errors, (state.positions[0].y - 1.0).abs() < 0.0001);
    check!(errors, (state.positions[1].x - 2.0).abs() < 0.0001);
    check!(errors, (state.positions[1].y - 1.0).abs() < 0.0001);
