...
use super::messages::{RedrawFloorCommand, UpdateSubtitleCommand};
...
pub struct UpdateSubtitleBehavior {
    ...
    receiver: Option<Receiver<UpdateSubtitleCommand>>,
}
...
impl UpdateSubtitleBehavior {
    ...
    pub fn new_with_receiver(
        global_state: Rc<GlobalStateActor>,
        redraw_sender: Sender<RedrawFloorCommand>,
        receiver: Receiver<UpdateSubtitleCommand>,
    ) -> Self {
        Self {
            global_state,
            redraw_sender,
    ...
    fn update_subtitle(&self, value: &str) {
...
impl Behavior<ChoreographySettingsViewModel> for UpdateSubtitleBehavior {
    fn activate(
        ...
        BehaviorLog::behavior_activated("UpdateSubtitleBehavior", "ChoreographySettingsViewModel");
        ...
        timer.start(TimerMode::Repeated, Duration::from_millis(16), move || {
            while let Ok(command) = receiver.try_recv() {
                behavior.update_subtitle(&command.value);
            }
        });
