...
use super::{GlobalStateModel, GlobalStateStore};

pub struct GlobalProvider {
    global_state_store: Rc<GlobalStateStore>,
...
impl GlobalProvider {
    pub fn new() -> Self
    {
        let global_state_store = GlobalStateStore::new();
    ...
    pub fn global_state_store(&self) -> Rc<GlobalStateStore>
    {
