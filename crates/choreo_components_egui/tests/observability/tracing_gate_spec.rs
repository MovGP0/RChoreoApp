...
use choreo_components_egui::observability::is_tracing_enabled;
use choreo_components_egui::observability::set_tracing_enabled;
use choreo_components_egui::observability::start_internal_span;
