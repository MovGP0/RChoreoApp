...
use crate::components::StateLayerStyle;
use crate::components::apply_tooltip;
use crate::components::icon::icon_with_style;
use crate::components::paint_state_layer_for_response;
    ...
    pub fn show(&mut self, ui: &mut Ui) -> Response {
        ...
        if is_checked {
            ...
            let image = icon_with_style(
                image,
                crate::components::icon::MaterialIconStyle {
                    size: box_size,
