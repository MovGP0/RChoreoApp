...
- `crates/choreo_components/src/choreo_main/reducer.rs` already contains most of the main page state transition logic.
...
```text
crates/choreo_components/src/app/
  action.rs
  effect.rs
  reactor.rs
  runtime.rs
